...
select *from [TINHLUONGNHANVIEN]
DELETE FROM [TINHLUONGNHANVIEN]
DECLARE @Thang INT = 3, @Nam INT = 2025;
SELECT SUM([TONG]) FROM TINHLUONGNHANVIEN WHERE TINHTRANG = 1 AND MONTH([THANG]) = @Thang AND YEAR([NAM]) = @Nam
SELECT * FROM TINHLUONGNHANVIEN WHERE TINHTRANG = 1;
SELECT SUM(TONG) 
FROM TINHLUONGNHANVIEN 
WHERE TINHTRANG = 1 
AND MONTH(NGAYTAO) = 3 
AND YEAR(NGAYTAO) = 2025;
...
CREATE TABLE [dbo].[HANGTONKHO](
	...
	[MATAIKHOAN] INT , 
	CONSTRAINT FK_HANGTONKHO_TAIKHOAN FOREIGN KEY ([MATAIKHOAN])
...
--8 Lich su nhan vien
CREATE TABLE [dbo].[TINHLUONGNHANVIEN](
	...
	[TINHTRANG] INT NULL,
	[MATAIKHOAN] INT,
	CONSTRAINT FK_TINHLUONG_TAIKHOAN FOREIGN KEY ([MATAIKHOAN])
    REFERENCES [dbo].[TAIKHOAN]([MATAIKHOAN])
)
...
GO
ALTER TABLE TINHLUONGNHANVIEN
ADD CONSTRAINT DF_TINHTRANG DEFAULT 0 FOR TINHTRANG;
...
GO
/*INSERT [dbo].[CHITIETHOADON] ([MAHOADON], [MASANPHAM], [SOLUONG]) VALUES (1, 2, 1, NULL, 0)
INSERT [dbo].[CHITIETHOADON] ([MAHOADON], [MASANPHAM], [SOLUONG]) VALUES (1, 10, 2, 100000, 0)*/
...
GO
INSERT INTO [dbo].[TAIKHOAN] ([MATAIKHOAN], [PASS], [TEN], [CCCD], [SODIENTHOAI], [DIACHI], [QUYEN], [TRANGTHAI], [LUONG])  
VALUES  
(111, '123', N'Admin', '123456789012345', '0987654321', N'Sóc Trăng', 0, 1, 10000000)
INSERT INTO [dbo].[TAIKHOAN] ([MATAIKHOAN], [PASS], [TEN], [CCCD], [SODIENTHOAI], [DIACHI], [QUYEN], [TRANGTHAI], [LUONG])  
VALUES  
(112233, '1234', N'Nguyễn Văn A', '123456789012345', '0987654321', N'Sóc Trăng', 1, 1, 10000000)  
